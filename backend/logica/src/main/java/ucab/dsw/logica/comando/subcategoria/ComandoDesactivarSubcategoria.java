...
public class ComandoDesactivarSubcategoria implements ComandoBase{

  private  long idSubcategoria;
  private  SubcategoriaDto subcategoriaDto;

  public ComandoDesactivarSubcategoria(long idSubcategoria){ this.idSubcategoria = idSubcategoria;}
